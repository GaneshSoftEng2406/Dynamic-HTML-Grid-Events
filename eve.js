var productData = {
  ...
  for (var i = 0; i < photos.length; i++) {
    if (i == 0) {
      previewImgDiv.innerHTML += ` <img  id ="img${i}" onclick =  "smallImageClicked('img${i}')"   class = "active" src= ${photos[i]}  /> `;
    } else {
      previewImgDiv.innerHTML += ` <img  id = "img${i}" onclick =  "smallImageClicked('img${i}')" src= ${photos[i]}  /> `;
    }
  }
